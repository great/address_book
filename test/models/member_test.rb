...
class MemberTest < ActiveSupport::TestCase
  ...
  test 'should have fields' do
    assert @member.respond_to? :name
    assert @member.respond_to? :email
    assert @member.respond_to? :password
    assert @member.respond_to? :password_digest
    assert @member.respond_to? :password_confirmation
    #assert member.respond_to? :remember_token
  end

  test 'when name is not present' do
    @member.name = ' '
    assert_not @member.valid? :name
  end
  ...
  test 'when email address is already taken' do
    ...
    assert_not member_with_same_email.save
  end
